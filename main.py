...
def play_game(attempts=5):
        # It will contain the main logic of my game.

        # It will store the value of randomly picked word.
        selected_word = pick_random_word()

        # It will show the current state of the word.
        current_word_state = ""
        ...
        while True:
                ...
                game_ended_checker = check_game_status(selected_word, current_word_state, attempts_remaining)
                
                if(game_ended_checker == False):
                        break
